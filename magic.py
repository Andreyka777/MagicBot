...
answers = ["Конечно.......да", "Конечно.......нет🤥", "Ну не знаю...", "Ответ на этот вопрос знает только Вселенная😝", "Несомненно", "Секрет🤫🤫🤫", "Сомнительно, но okey", "Я не являюсь политиком и никогда им не был. Меня политика не интересует", "Я сказал, и много что сказал. Не надо мне пожаласта это предъявлять"]
